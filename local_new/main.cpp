...
// 模拟 far_memory 命名空间以减少代码改动
namespace far_memory {

class LocalWebServiceTest {
private:
    // --- Benchmark Parameters (与原论文保持一致) ---
    // Hashtable.
    ...
    static constexpr uint32_t kNumBenchmarkLoops = 4; // 循环次数可以调整
    static constexpr uint64_t kTotalTargetRequests = kNumReqs * kNumBenchmarkLoops;
...
int main() {
    // 确保你的 zipf.hpp 和 zipf.ipp 在包含路径中
